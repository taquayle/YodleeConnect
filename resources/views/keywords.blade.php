<html lang="{{ config('app.locale') }}">
  ...
  <body>
    ...
    function prettyPrint($stock, $keys){
      ...
      print "<table width=99%>";
      print "<tr><th colspan='2'>" . googleSearch($stock['name']) . "</th></tr>";
    ...
    <div class="leftCol">
      ...
      <div style='float:right'>
        <form method="get" action="/keywords/edit">
          <input type="submit" value="Random" name="submit" class='randomButton'>
        </form>
      </div>
      <div width=100px>
        <div >
          <form method='post' action='/keywords/edit'>
            ...
            <div style='float:left'>
              <h3> Custom keywords. (,) delimted </h3>
            ...
            <div style='clear:both'>
              <h3> <br>Add Keywords </h3>
              <h4> Keywords submitted by or obtained from users </h4>
              <?php keyWordCheckBox($userKeywords, 'add', 5) ?>
              <h3> Delete Keywords </h3>
              <h4> Keywords belonging to current stock </h4>
              <?php
                if($goodIndex)
            ...
            <br>
            <input type="submit" value="Submit" name="submit" class='largeButton'>
          </form>
        </div>
